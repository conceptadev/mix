...
const ThemeConfigSchema = _utilsValidation.Joi.object({
  ...
  docs: DocsSchema,
  metadatas: _utilsValidation.Joi.array().items(HtmlMetadataSchema).default(DEFAULT_CONFIG.metadatas),
  ...
  footer: _utilsValidation.Joi.object({
    ...
    links: _utilsValidation.Joi.array().items(_utilsValidation.Joi.object({
      title: _utilsValidation.Joi.string().allow(null),
