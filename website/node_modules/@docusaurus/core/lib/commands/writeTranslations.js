...
async function getExtraSourceCodeFilePaths() {
    try {
        ...
        return translationsExtractor_1.globSourceCodeFilePaths([themeCommonSourceDir]);
    }
    catch (e) {
...
Available locales are: ${context.i18n.locales.join(',')}.`);
    ...
    const extractedCodeTranslations = await translationsExtractor_1.extractSiteSourceCodeTranslations(siteDir, plugins, babelOptions, await getExtraSourceCodeFilePaths());
