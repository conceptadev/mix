...
const slugs = new github_slugger_1.default();
function headings() {
    const transformer = (ast) => {
        slugs.reset();
        const visitor = (headingNode) => {
            ...
            if (id) {
                ...
                const heading = mdast_util_to_string_1.default(headingTextNodes.length > 0
                    ? { children: headingTextNodes }
                    : headingNode);
                // Support explicit heading IDs
                const parsedHeading = utils_1.parseMarkdownHeadingId(heading);
                ...
                if (parsedHeading.id) {
                    ...
                    if (headingNode.children.length > 1) {
                        const lastNodeText = utils_1.parseMarkdownHeadingId(lastNode.value).text;
        ...
        unist_util_visit_1.default(ast, 'heading', visitor);
    };
    return transformer;
}
