...
const PluginInstanceContent = ({ pluginId, pluginInstanceContent, }) => (react_1.default.createElement("section", { style: { marginBottom: 30 } },
...
const PluginContent = ({ pluginName, pluginContent, }) => {
    return (react_1.default.createElement("section", { style: { marginBottom: 60 } },
        ...
        react_1.default.createElement("div", null, Object.entries(pluginContent)
            ...
            return (react_1.default.createElement(PluginInstanceContent, { key: pluginId, pluginId: pluginId, pluginInstanceContent: pluginInstanceContent }));
        }))));
};
function DebugContent({ allContent }) {
    return (react_1.default.createElement(DebugLayout_1.default, null,
        ...
        react_1.default.createElement("div", null, Object.entries(allContent)
            ...
            return (react_1.default.createElement(PluginContent, { key: pluginName, pluginName: pluginName, pluginContent: pluginContent }));
        }))));
}
