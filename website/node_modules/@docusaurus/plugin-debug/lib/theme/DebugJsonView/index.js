...
function DebugJsonView({ src, collapseDepth }) {
    return (react_1.default.createElement(BrowserOnlyReactJson
    ...
    , { 
        ...
        }, collapsed: collapseDepth, groupArraysAfterLength: 5, enableClipboard: false, displayDataTypes: false }));
}
