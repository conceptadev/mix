...
- `p`, `padding`: Margin
- `pt`, `paddingTop`: Margin top
- `pb`, `paddingBottom`: Margin bottom
- `pr`, `paddingRight`: Margin right
- `pl`, `paddingLeft`: Margin left
- `px`, `paddingHorizontal`, `paddingX`: Margin horizontal
- `py`, `paddingVertical`, `paddingY`: Margin vertical
- `pi`, `paddingInsets`: Margin insets - `pi(EdgeInsets.only(top: 10.0, right: 5.0))`
