...
Applies Attributes from a Mix variant. Read more about on the [Variant](/docs/variant) page.

#### `.withMaybeVariant(Variant?)`

Same as `withVariant` but allows you to pass a nullable Variant.
