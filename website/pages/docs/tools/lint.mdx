...
<div className="flex justify-between">
  <div className="w-1/3 mr-24">
    <img src="./images/assist-extract-attributes.gif" alt="extract-attributes" className="w-full" />
  </div>
  <div className="w-1/3 mx-24">
    <img src="./images/assist-extract-attributes-2.gif" alt="extract-attributes-2" className="w-full" />
  </div>
  <div className="w-1/3 ml-24">
    <img src="./images/assist-extract-attributes-3.gif" alt="extract-attributes-3" className="w-full" />
  </div>
</div>
