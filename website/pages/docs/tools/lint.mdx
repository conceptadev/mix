...
The assistant can extract attributes even when the style is in different code structures.
- Field declarations
...
<div className="flex justify-between gap-4 mt-4">
  <div className="w-1/3">
    <Image src="/images/assist-extract-attributes.gif" alt="extract-attributes" className="w-full" />
  </div>
  <div className="w-1/3">
    <Image src="/images/assist-extract-attributes-2.gif" alt="extract-attributes-2" className="w-full" />
  </div>
  <div className="w-1/3">
    <Image src="/images/assist-extract-attributes-3.gif" alt="extract-attributes-3" className="w-full" />
  </div>
</div>
