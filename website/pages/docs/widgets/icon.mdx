...
In the above example, the `StyledIcon` widget will inherit the icon size and color style from the `Box` widget. However, remember that modifiers attributes cannot be inherited.
