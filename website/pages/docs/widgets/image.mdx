...
In this example, the `StyledImage` widget will inherit the image height and color from the `Box` widget. However, remember that modifier attributes cannot be inherited.
