...
You can mix new attributes into the style by calling it as a function and passing the attributes as parameters. For example:
...
**Taking Control** You can also override specific attributes of a style by passing new values as parameters method. For instance:
