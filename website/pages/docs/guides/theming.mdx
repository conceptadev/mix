  ...
  Widget build(BuildContext context) {
    return Box(
      style: Style(
        ...
        $box.color.ref($colors.primary),
        $box.alignment.center(),
        $box.borderRadius.all.ref($radii.large),
        $text.style.ref($textStyles.headline3),
        $text.style.color.ref($colors.onPrimary),
      ),
      child: StyledText(
        label,
      ),
...
Box(
  style: Style(
    $text.style.ref($md.textTheme.headline1),
    $box.color.ref($md.colorScheme.primary),
  ),
