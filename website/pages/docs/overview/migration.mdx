...
In our pursuit of API usability and efficiency, we introduced several deprecations in the latest Mix Package versions. If you encounter issues not covered by deprecation notices, please [open an issue or send a PR to our deprecation file](https://github.com/conceptadev/mix/blob/main/lib/src/deprecations.dart).
...
To enhance readability, short aliases and shorthand property/method names are replaced with their fully named counterparts. You can find the full list of removed aliases in the [deprecations file](https://github.com/conceptadev/mix/blob/main/lib/src/deprecations.dart)
