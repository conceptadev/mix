...
/// @nodoc
abstract class $GapAttributeCopyWith<$Res>
    implements $SizeAttributeCopyWith<$Res> {
  factory $GapAttributeCopyWith(
          GapAttribute value, $Res Function(GapAttribute) then) =
      _$GapAttributeCopyWithImpl<$Res>;
  @override
  $Res call({double size});
}

/// @nodoc
class _$GapAttributeCopyWithImpl<$Res> extends _$SizeAttributeCopyWithImpl<$Res>
    implements $GapAttributeCopyWith<$Res> {
  _$GapAttributeCopyWithImpl(
      GapAttribute _value, $Res Function(GapAttribute) _then)
      : super(_value, (v) => _then(v as GapAttribute));

  @override
  GapAttribute get _value => super._value as GapAttribute;

  @override
  $Res call({
    Object? size = freezed,
  }) {
    return _then(GapAttribute(
      size == freezed
          ? _value.size
          : size // ignore: cast_nullable_to_non_nullable
              as double,
...
class _$GapAttribute extends GapAttribute {
  _$GapAttribute(this.size) : super._();
  ...
  @override
  String toString() {
    return 'SizeAttribute.gap(size: $size)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is GapAttribute &&
            (identical(other.size, size) ||
                const DeepCollectionEquality().equals(other.size, size)));
  }
  ...
  @JsonKey(ignore: true)
  @override
  $GapAttributeCopyWith<GapAttribute> get copyWith =>
      _$GapAttributeCopyWithImpl<GapAttribute>(this, _$identity);
...
abstract class GapAttribute extends SizeAttribute {
  factory GapAttribute(double size) = _$GapAttribute;
  GapAttribute._() : super._();
