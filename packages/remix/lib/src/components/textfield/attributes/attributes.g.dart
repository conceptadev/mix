...
/// from predefined [BoxHeightStyle] values.
/// {@endtemplate}
mixin _$BoxHeightStyleUtility<T extends Attribute>
  ...
  /// Creates an [Attribute] instance with [BoxHeightStyle.max] value.
  T max() => builder(BoxHeightStyle.max);

  /// Creates an [Attribute] instance with [BoxHeightStyle.includeLineSpacingMiddle] value.
  T includeLineSpacingMiddle() =>
      builder(BoxHeightStyle.includeLineSpacingMiddle);

  /// Creates an [Attribute] instance with [BoxHeightStyle.includeLineSpacingTop] value.
  T includeLineSpacingTop() => builder(BoxHeightStyle.includeLineSpacingTop);

  /// Creates an [Attribute] instance with [BoxHeightStyle.includeLineSpacingBottom] value.
  T includeLineSpacingBottom() =>
      builder(BoxHeightStyle.includeLineSpacingBottom);
...
/// A utility class for creating [Attribute] instances from [BoxWidthStyle] values.
///
/// This class extends [MixUtility] and provides methods to create [Attribute] instances
/// from predefined [BoxWidthStyle] values.
/// {@endtemplate}
...
/// A utility class for creating [Attribute] instances from [Brightness] values.
///
/// This class extends [MixUtility] and provides methods to create [Attribute] instances
