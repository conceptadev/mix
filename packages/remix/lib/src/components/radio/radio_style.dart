...
class XRadioStyle {
  static Style get container => Style(
        ...
        $on.disabled(_container.border.color.black.brighten(80)),
        $on.dark(
          _container.border.all.color.white(),
          $on.disabled(_container.border.color.black.darken(30)),
        ),
      );
  static Style get indicator => Style(
        ...
        $on.disabled(_indicator.color.black.brighten(70)),
        $on.dark(
          _indicator.color.white(),
          $on.disabled(_indicator.color.black.darken(50)),
        ),
      );
  ...
  static Style get base =>
      Style(container(), indicator(), text(), flex()).animate(
