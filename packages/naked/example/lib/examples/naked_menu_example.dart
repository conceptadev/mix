    ...
    return Column(
      ...
      children: [
        ...
        NakedMenu(
          ...
          // Add constraints to control menu width
          offset: const Offset(0, 4),
          // child contains both Trigger and Content
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              NakedMenuTrigger(
              ...
              // Content is shown/hidden based on NakedMenu.isOpen
              NakedMenuContent(
                child: _buildMenuContentVisual(),
              ),
            ],
          ),
        ),
      ...
      children: [
        ...
        NakedMenu(
          ...
          onIsOpenChanged: (isOpen) {
            ...
            if (!isOpen) {
              setState(() => _lastAction = 'Menu Closed');
            }
          },
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              NakedMenuContent(
                child: _buildFocusMenuContentVisual(),
              ),
            ],
          ),
        ),
