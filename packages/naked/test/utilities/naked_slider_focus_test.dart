...
void main() {
  group('NakedSlider with NakedFocusManager', () {
    ...
    testWidgets('handles page up/down for larger steps',
        (WidgetTester tester) async {
      double value = 0.5;
      final focusNode = FocusNode();
      ...
      // Page Up should make a larger step increase
      await tester.sendKeyEvent(LogicalKeyboardKey.pageUp);
      await tester.pump();
      // Should increase by largeKeyboardStep (0.1)
      expect(value, closeTo(0.6, 0.001),
          reason: 'Value should increase by largeKeyboardStep with Page Up');

      // Page Down should make a larger step decrease
      await tester.sendKeyEvent(LogicalKeyboardKey.pageDown);
      await tester.pump();
      // Should be back to original value
      expect(value, closeTo(0.5, 0.001),
          reason: 'Value should decrease by largeKeyboardStep with Page Down');
    });
  });
}
