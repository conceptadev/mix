...
void main() {
  group('Spacing Utils', () {
    final spacingUtils = EdgeInsetsGeometryMixUtility(UtilityTestAttribute.new);
    test('padding()', () {
      expect(
    ...
    test('spacingUtils.from', () {
      ...
      expect(
        ...
        EdgeInsetsGeometryMix.only(top: 10, bottom: 0, left: 0, right: 0),
        reason: '2',
      );

      expect(
        spacingUtils.as(const EdgeInsets.only(left: 10)).value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 0, left: 10, right: 0),
        reason: '3',
      );

      expect(
        spacingUtils.as(const EdgeInsets.only(right: 10)).value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 0, left: 0, right: 10),
        reason: '4',
      );

      expect(
        spacingUtils.as(const EdgeInsets.only(bottom: 10)).value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 10, left: 0, right: 0),
        reason: '5',
      );

      expect(
        spacingUtils.as(const EdgeInsets.symmetric(horizontal: 10)).value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 0, left: 10, right: 10),
        reason: '6',
      );

      expect(
        spacingUtils.as(const EdgeInsets.symmetric(vertical: 10)).value,
        EdgeInsetsGeometryMix.only(top: 10, bottom: 10, left: 0, right: 0),
        reason: '7',
      );
      ...
      expect(
        spacingUtils.directional
            ...
            .value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 0, start: 10, end: 0),
        reason: '8',
      );
      ...
      expect(
        spacingUtils.directional
            ...
            .value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 0, start: 0, end: 10),
        reason: '9',
      );
      ...
      expect(
        spacingUtils.directional
            ...
            .value,
        EdgeInsetsGeometryMix.only(top: 10, bottom: 0, start: 0, end: 0),
        reason: '10',
      );
      ...
      expect(
        spacingUtils.directional
            ...
            .value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 10, start: 0, end: 0),
        reason: '11',
      );
      ...
      expect(
        spacingUtils.directional
            ...
            .value,
        EdgeInsetsGeometryMix.only(top: 0, bottom: 0, start: 10, end: 20),
        reason: '12',
      );
      ...
      expect(
        spacingUtils.directional
            ...
            .value,
        EdgeInsetsGeometryMix.only(top: 30, bottom: 0, start: 10, end: 20),
        reason: '13',
      );
    ...
    test('spacingUtils.right', () {
      expect(
          spacingUtils.right(10).value, EdgeInsetsGeometryMix.only(right: 10));
    });
