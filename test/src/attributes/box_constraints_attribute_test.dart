  ...
  group('BoxConstraintsAttribute', () {
    test('from constructor sets all values correctly', () {
      const constraints = BoxConstraints(
          minWidth: 50, maxWidth: 150, minHeight: 100, maxHeight: 200);
      final attr = BoxConstraintsAttribute.from(constraints);
    ...
    test('merge returns merged object correctly', () {
      ...
      expect(merged.minWidth, 60); // should take from attr2
      expect(merged.minHeight, 110); // should take from attr2
