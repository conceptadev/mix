  ...
  group('TextSpec', () {
    test('resolve', () {
      final mix = MixData.create(
        ...
        StyleMix(
          ...
          const TextDirectiveAttribute([UppercaseDirective()]),
        ),
      );
      ...
      expect(spec.directives, [const UppercaseDirective()]);
    ...
    test('copyWith', () {
      ...
      final copiedSpec = spec.copyWith(
        ...
        softWrap: false,
        directives: [const LowercaseDirective()],
      );
      ...
      expect(copiedSpec.directives, [const LowercaseDirective()]);
    });
    ...
    test('lerp', () {
      ...
      expect(lerpedSpec.directives, [const LowercaseDirective()]);
