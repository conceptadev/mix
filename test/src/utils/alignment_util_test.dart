...
void main() {
  group('AlignmentGeometryAttribute utilities:', () {
    ...
    test(
      ...
      expect(alignment.centerLeft.resolve(EmptyMixData), Alignment.centerLeft);
      ...
      expect(alignment.bottomLeft.resolve(EmptyMixData), Alignment.bottomLeft);
      ...
      expect(
          alignment.bottomCenter.resolve(EmptyMixData), Alignment.bottomCenter);
    ...
    test(
      ...
      expect(
          alignment.topEnd.resolve(EmptyMixData), AlignmentDirectional.topEnd);
