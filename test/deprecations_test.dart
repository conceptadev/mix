...
void main() {
  ...
  group('Deprecated utilities', () {
    ...
    test('box utilities', () {
      ...
      expect(w(10), width(10));
      expect(maxH(10), maxHeight(10));
      expect(maxW(10), maxWidth(10));
      expect(minH(10), minHeight(10));
      expect(minW(10), minWidth(10));
    });

    test('border utilities', () {
      expect(bt(width: 2), border.top(width: 2));
      expect(bb(width: 2), border.bottom(width: 2));
      expect(bl(width: 2), border.left(width: 2));
      expect(br(width: 2), border.right(width: 2));
      expect(bs(width: 2), borderDirectional.start(width: 2));
      expect(be(width: 2), borderDirectional.end(width: 2));
    });
    ...
    test('text utilities', () {
      ...
      expect(textBgColor(Colors.blue), text.style.backgroundColor(Colors.blue));
      ...
      expect(textDecorationThickness(2.0), text.style.decorationThickness(2.0));
    ...
    test('padding utilities', () {
      expect(p(10), padding(10));
      expect(pt(10), padding.top(10));
      expect(pb(10), padding.bottom(10));
      expect(pr(10), padding.right(10));
      expect(pl(10), padding.left(10));
      expect(ps(10), padding.start(10));
      expect(pe(10), padding.end(10));
      expect(px(10), padding.horizontal(10));
      expect(py(10), padding.vertical(10));
      expect(
          pi(const EdgeInsets.all(10)), padding.as(const EdgeInsets.all(10)));
      expect(paddingInsets(const EdgeInsets.all(10)),
          padding.as(const EdgeInsets.all(10)));
    });

    test('margin utilities', () {
      expect(m(10), margin(10));
      expect(mt(10), margin.top(10));
      expect(mb(10), margin.bottom(10));
      expect(mr(10), margin.right(10));
      expect(ml(10), margin.left(10));
      expect(ms(10), margin.start(10));
      expect(me(10), margin.end(10));
      expect(mx(10), margin.horizontal(10));
      expect(my(10), margin.vertical(10));
      expect(mi(const EdgeInsets.all(10)), margin.as(const EdgeInsets.all(10)));
      expect(marginTop(10), margin.top(10));
      expect(marginBottom(10), margin.bottom(10));
      expect(marginLeft(10), margin.left(10));
      expect(marginRight(10), margin.right(10));
      expect(marginStart(10), margin.start(10));
      expect(marginEnd(10), margin.end(10));
      expect(marginHorizontal(10), margin.horizontal(10));
      expect(marginVertical(10), margin.vertical(10));
      expect(marginFrom(const EdgeInsets.all(10)),
          margin.as(const EdgeInsets.all(10)));
      expect(marginX(10), margin.horizontal(10));
      expect(marginY(10), margin.vertical(10));
      expect(marginOnly(left: 10), margin.only(left: 10));
      expect(marginDirectionalOnly(start: 10), margin.only(start: 10));
      expect(marginAll(10), margin.all(10));
    });

    test('border radius utilities', () {
      expect(r(10), borderRadius(10));
      expect(roundedTL(10), borderRadius.topLeft(10));
      expect(roundedTR(10), borderRadius.topRight(10));
      expect(roundedBL(10), borderRadius.bottomLeft(10));
      expect(roundedBR(10), borderRadius.bottomRight(10));
      expect(roundedTS(10), borderRadiusDirectional.topStart(10));
      expect(roundedTE(10), borderRadiusDirectional.topEnd(10));
      expect(roundedBS(10), borderRadiusDirectional.bottomStart(10));
      expect(roundedBE(10), borderRadiusDirectional.bottomEnd(10));
    });
    ...
    test('squared utility', () {
      expect(squared(), borderRadius.zero());
    });
